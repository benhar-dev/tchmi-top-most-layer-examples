declare module TcHmi.Controls.Beckhoff {
    class TcHmiDatagrid extends TcHmi.Controls.System.TcHmiControl {
        ...
        /** Key-value object of saved runtime states
         * key must be in a white list of supported states */
         ...
         */
        protected __getStoredValue<K extends keyof TcHmiDatagrid.Storage>(key: K): TcHmiDatagrid.Storage[K]['anonymousUser'] | undefined;
        /**
    ...
    module TcHmiDatagrid {
        ...
        interface StorageItem<V, A> {
            validation: {
                /** name of the function on this control which is tested */
                function: string;
                /** undefined is the value when this object is not filled yet */
                expectedResult: A | undefined;
            };
            /** Value for anonymous user */
            anonymousUser?: V;
            /** Value for each user (key is the user name) */
            users?: Dictionary<V>;
        }
